"""This example creates a 24-bit PCM .wav file with a sine wave whose amplitude is 0.5."""
...
def generate_sine_wave(frequency, duration_secs, sample_rate, amplitude):
...
def main():
    ...
    data = convert_wave_data_to_24bit_pcm_samples(sine_wave)
